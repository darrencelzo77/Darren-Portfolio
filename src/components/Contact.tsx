...
const Contact: React.FC = () => {
  const contactInfo = [
    ...
    {
      title: 'Location',
      info: 'San Miguel, Bulacan, Philippines',
      link: null,
      ...
      <div className="container-custom max-w-5xl mx-auto px-4">
        <header className="text-center mb-16">
          ...
          <p className="section-subtitle">
            Available for backend-heavy fullstack work, integrations, and deployment support.
          </p>
        </header>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <aside className="glass-panel rounded-2xl p-6">
            <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50 mb-3">Availability</h3>
            <p className="mb-4 text-slate-700 dark:text-slate-300">
              Open to roles, contracts, and technical collaborations.
            </p>
            <ul className="space-y-3 mb-5">
              <li className="chip">Backend APIs</li>
              <li className="chip">Deployment</li>
              <li className="chip">System Design</li>
            </ul>
